...
//        $this->productRepo->test();
    ...
    public function addProductToDB(SaveProductRequest $request)
    {
        ...
        return redirect(route('products.all'))->with('success', 'Uspesno ste dodali proizvod');
...
//        $product = Products::where(['id'=>$id])->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('products.all')->with('success', 'Uspesno ste azurirali Vas Proizvid');
