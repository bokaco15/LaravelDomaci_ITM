...
class ContactController extends Controller
{
    ...
    public function addContact(AddContactRequest $request)
    {
        ...
        return redirect(route('contacts.add'))->with('uspeh', 'Uspeno ste dodali kontakta');
    }
    ...
    public function deleteContact($id)
    {
        ...
        {
            $contact->delete();
            return redirect(route('contacts.all'))->with('uspeh', 'Uspesno si obrisao kontakta');
        }
        else
        {
            return redirect(route('contacts.all'))->with('greska', 'Ovaj korisnik ne postoji!!!');
        }
    }
    ...
    public function saveUpdate(UpdateContactRequest $request, $id)
    {
        ...
        return redirect()->route('contacts.all')->with('uspeh', "Uspesno ste azurirali kontakta {$contact['email']}");
    }
